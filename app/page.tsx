    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-luxury-black text-luxury-white">
      ...
      <section className="mt-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            <div className="bg-luxury-gold p-4 rounded-lg hover:bg-luxury-gold/80 transition duration-300">
      ...
      <section className="mt-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8">
            <button className="bg-luxury-gold text-luxury-black px-6 py-3 rounded-lg font-bold hover:bg-luxury-gold/80 transition duration-300">
